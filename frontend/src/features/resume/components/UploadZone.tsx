...
export default function UploadZone({
  ...
  return (
    <label className="bg-[rgba(23,31,51,0.5)] backdrop-blur-xl border-2 border-dashed border-[#adc6ff]/30 rounded-3xl p-10 flex flex-col items-center justify-center text-center group cursor-pointer hover:border-[#adc6ff]/60 transition-all duration-300">
      ...
      <p className="text-[#c2c6d6] mb-6">
        Supported formats:{" "}
        <span className="text-[#adc6ff] font-semibold">PDF only</span> (Max 5MB)
      </p>

      <div className="w-full max-w-sm">
        <div className="flex justify-between items-end mb-2">
          <span className="text-xs font-bold text-[#c2c6d6]">{loading ? "Uploading..." : "Choose Resume"}</span>
